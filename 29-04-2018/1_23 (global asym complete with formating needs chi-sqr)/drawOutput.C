...
void drawOutput() {
  ...
  const Int_t xNBINS = 25;
  const Int_t yNBINS = 22;
...
//  BNegPeak->SetParameters(&FinPar_neg[5]);
  ...
  // Calculating N+
  Double_t N_Pos = par_pos[5];
  
  // Calculating N-
  Double_t N_Neg = par_neg[5];
 ...
 //Draw Legend:
  ...
  c2->SaveAs("InvMassBmeson_Neg.pdf");
...
/*
  ...
  TCanvas *c9 = new TCanvas("c9","Pi- Pi+",600,400);
...
/*
  ...
  */
  ...
  TCanvas *c27 = new TCanvas("27","Asymmetry",600,400);
  Asym_Local_Dalitz->Sumw2();
  Asym_Local_Dalitz->SetTitle("Asymmetry: B#frac{+}{-} ->K#Pi#Pi");
  ...
  Asym_Local_Dalitz->SetBinContent(6,16,-6);
  Asym_Local_Dalitz->SetBinContent(8,15,-6);
  Asym_Local_Dalitz->SetBinContent(10,14,-6);
  Asym_Local_Dalitz->SetBinContent(11,13,-6);
  Asym_Local_Dalitz->SetBinContent(14,10,-6);
  Asym_Local_Dalitz->SetBinContent(16,9,-6);
   ...
   for(int binX(1); binX <= xNBINS; binX++){
	...
	Asym_Local_Dalitz->SetBinContent(binX,binY,-6);// Setting to -6 as out of range of plot -> goes to white
      } 
	...
	Asym_Local_Dalitz->SetBinContent(binX,binY,-6);// Setting to -6 as out of range of plot -> goes to white
     ...
     // Asym_Local_Dalitz->SetBinContent(binX,binY,-6);
     double Asym_local(0);
  ...
  c27->SaveAs("Asymmetry.pdf");
  
  TH2F *Asym_Sig_Local_Dalitz = (TH2F*) Asym_Local_Dalitz;
  
  Asym_Sig_Local_Dalitz->SetBinContent(6,16,-6);
  Asym_Sig_Local_Dalitz->SetBinContent(8,15,-6);
  Asym_Sig_Local_Dalitz->SetBinContent(10,14,-6);
  Asym_Sig_Local_Dalitz->SetBinContent(11,13,-6);
  Asym_Sig_Local_Dalitz->SetBinContent(14,10,-6);
  Asym_Sig_Local_Dalitz->SetBinContent(16,9,-6);
  ...
  for(int binX(1); binX <= xNBINS; binX++){
    for(int binY(1); binY <= yNBINS; binY++){
     ...
     // Asym_Sig_Local_Dalitz->SetBinContent(11,11,-6);
     // Asym_Sig_Local_Dalitz->SetBinContent(8,13,-6);
   
      
      if (SignificanceOfBinAsym == 0){
	Asym_Sig_Local_Dalitz->SetBinContent(binX,binY,-6);
      }
  ...
  TCanvas *c26 = new TCanvas("26","Asymmetry Error Significance",600,400);
  Asym_Sig_Local_Dalitz->Sumw2();
  Asym_Sig_Local_Dalitz->SetTitle("Asymmetry Error Significance: B#frac{+}{-} ->K#Pi#Pi");
  ...
  c26->SaveAs("Asym_ErrorSignificance.pdf");
