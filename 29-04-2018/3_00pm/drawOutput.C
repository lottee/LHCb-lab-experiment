...
/*
  ...
  */
  ...
  Asym_Local_Dalitz->SetBinContent(9,15,-6);
  Asym_Local_Dalitz->SetBinContent(7,17,-6);
  Asym_Local_Dalitz->SetBinContent(6,18,-6);
  Asym_Local_Dalitz->SetBinContent(12,12,-6);
  ...
  for(int binX(1); binX <= xNBINS; binX++){
	...
	Asym_Sig_Local_Dalitz->SetBinContent(9,15,-6);
	Asym_Sig_Local_Dalitz->SetBinContent(7,17,-6);
	Asym_Sig_Local_Dalitz->SetBinContent(6,18,-6);
	Asym_Sig_Local_Dalitz->SetBinContent(12,12,-6);
	// extra ones which significant plot only contains
	Asym_Sig_Local_Dalitz->SetBinContent(9,14,-6);
	Asym_Sig_Local_Dalitz->SetBinContent(8,16,-6);
	Asym_Sig_Local_Dalitz->SetBinContent(11,11,-6);
	Asym_Sig_Local_Dalitz->SetBinContent(11,4,-6);
