...
// Define Histogram
h_MassBPos = new TH1F("h_MassBPos", "", 300, 5040, 5600);
h_MassBNeg = new TH1F("h_MassBNeg", "", 300, 5040, 5600); 
...
///resonant Identifier 
  ...
  if (H2_Charge == +1 && H2_ProbK > ProbKThreshold && H1_isMuon && H3_isMuon){
    if ((H1_Charge == -1 && H3_Charge == +1) || (H3_Charge == -1 && H1_Charge == +1)){
     ...
     // std::cout<<"Pos1:"<<H1_Charge<<" "<<H2_Charge<<" "<<H3_Charge<<std::endl;
      ...
      double E1_1 = Energy_calc(MUON,H1_PX, H1_PY, H1_PZ);
      double E1_2 = Energy_calc(KAON,H2_PX, H2_PY,H2_PZ);
      M1_Pos = invMass_D(KAON, MUON,E1_1,E1_2, P1_12); 

      double P2_12 = mv_3DotProd(H3_PX, H3_PY, H3_PZ, H2_PX, H2_PY, H2_PZ);
      double E2_1 = Energy_calc(MUON,H3_PX, H3_PY, H3_PZ);
      double E2_2 = Energy_calc(MUON,H2_PX, H2_PY, H2_PZ);
      M2_Pos = invMass_D(MUON,KAON,E2_1,E2_2, P2_12);

      double P3_12 = mv_3DotProd(H1_PX, H1_PY, H1_PZ, H3_PX, H3_PY, H3_PZ);
      double E3_1 = Energy_calc(MUON,H1_PX, H1_PY, H1_PZ);
      double E3_2 = Energy_calc(MUON,H3_PX, H3_PY, H3_PZ);
      M3_Pos = invMass_D(MUON,MUON,E3_1, E3_2, P3_12);
    }
  }

  // Negative
  else if (H2_Charge == -1 && H2_ProbK > ProbKThreshold && H1_isMuon && H3_isMuon){
    if ((H1_Charge == -1 && H3_Charge == +1) || (H3_Charge == -1 && H1_Charge == +1)){
      ...
      double E1_1 = Energy_calc(MUON,H1_PX, H1_PY, H1_PZ);
      double E1_2 = Energy_calc(KAON,H2_PX, H2_PY,H2_PZ);
      M1_Neg = invMass_D(KAON, MUON,E1_1,E1_2, P1_12); 

      double P2_12 = mv_3DotProd(H3_PX, H3_PY, H3_PZ, H2_PX, H2_PY, H2_PZ);
      double E2_1 = Energy_calc(MUON,H3_PX, H3_PY, H3_PZ);
      double E2_2 = Energy_calc(KAON,H2_PX, H2_PY, H2_PZ);
      M2_Neg = invMass_D(MUON,KAON,E2_1,E2_2, P2_12);

      double P3_12 = mv_3DotProd(H1_PX, H1_PY, H1_PZ, H3_PX, H3_PY, H3_PZ);
      double E3_1 = Energy_calc(MUON,H1_PX, H1_PY, H1_PZ);
      double E3_2 = Energy_calc(MUON,H3_PX, H3_PY, H3_PZ);
      M3_Neg = invMass_D(MUON,MUON,E3_1, E3_2, P3_12);

    }
  }

  // Positive 
  else if (H1_Charge == +1 && H1_ProbK > ProbKThreshold && H2_isMuon && H3_isMuon){
    if ((H2_Charge == -1 && H3_Charge == +1) || (H3_Charge == -1 && H2_Charge == +1)){
      ...
      Mass2 = Mass3 = MUON; // " " pion
     // std::cout<<"Pos2:"<<H1_Charge<<" "<<H2_Charge<<" "<<H3_Charge<<std::endl;
      double P1_12 = mv_3DotProd(H1_PX, H1_PY, H1_PZ, H2_PX, H2_PY, H2_PZ);
      double E1_1 = Energy_calc(KAON,H1_PX, H1_PY, H1_PZ);
      double E1_2 = Energy_calc(MUON,H2_PX, H2_PY,H2_PZ);
      M1_Pos = invMass_D(KAON, MUON,E1_1,E1_2, P1_12);

      double P2_12 = mv_3DotProd(H3_PX, H3_PY, H3_PZ, H2_PX, H2_PY, H2_PZ);
      double E2_1 = Energy_calc(MUON,H3_PX, H3_PY, H3_PZ);
      double E2_2 = Energy_calc(MUON,H2_PX, H2_PY, H2_PZ);
      M3_Pos = invMass_D(MUON,MUON,E2_1,E2_2, P2_12);

      double P3_12 = mv_3DotProd(H1_PX, H1_PY, H1_PZ, H3_PX, H3_PY, H3_PZ);
      double E3_1 = Energy_calc(KAON,H1_PX, H1_PY, H1_PZ);
      double E3_2 = Energy_calc(MUON,H3_PX, H3_PY, H3_PZ);
      M2_Pos = invMass_D(KAON,MUON,E3_1, E3_2, P3_12);
    }
  }
  ...
  // Negative
    ...
    if ((H2_Charge == -1 && H3_Charge == +1) || (H3_Charge == -1 && H2_Charge == +1)){
      ...
      double E2_1 = Energy_calc(MUON,H3_PX, H3_PY, H3_PZ);
      double E2_2 = Energy_calc(MUON,H2_PX, H2_PY, H2_PZ);
      M3_Neg = invMass_D(MUON,MUON,E2_1,E2_2, P2_12);

      double P3_12 = mv_3DotProd(H1_PX, H1_PY, H1_PZ, H3_PX, H3_PY, H3_PZ);
      double E3_1 = Energy_calc(KAON,H1_PX, H1_PY, H1_PZ);
      double E3_2 = Energy_calc(MUON,H3_PX, H3_PY, H3_PZ);
      M2_Neg = invMass_D(KAON,MUON,E3_1, E3_2, P3_12);
    }
  }

  //(3) Cut for the J/Psi Meson 
  // Positive
  else if (H3_Charge == +1 && H3_ProbK > ProbKThreshold && H2_isMuon && H1_isMuon){
    if ((H1_Charge == -1 && H2_Charge == +1) || (H2_Charge == -1 && H1_Charge == +1)){
      Mass3 = KAON;
      Mass1 = Mass2 = MUON;
      double P3_12 = mv_3DotProd(H1_PX, H1_PY, H1_PZ, H2_PX, H2_PY, H2_PZ);
      double E3_1 = Energy_calc(MUON,H1_PX, H1_PY, H1_PZ);
      double E3_2 = Energy_calc(MUON,H2_PX, H2_PY, H2_PZ);
      M3_Pos = invMass_D(MUON,MUON,E3_1, E3_2, P3_12);
      ...
      double E2_2 = Energy_calc(MUON,H1_PX, H1_PY, H1_PZ);
      M2_Pos = invMass_D(MUON,KAON,E2_1,E2_2, P2_12);
    }  
  }
...
// Check one particle is positive, 2 are negative
  ...
  if (H1_Charge == +1 && H1_ProbK > ProbKThreshold && H2_isMuon && H3_isMuon){
    if (H2_Charge == -1 && H3_Charge == +1 || H3_Charge == -1 && H2_Charge == +1){
      Mass1 = KAON;
      Mass3 = Mass2 = MUON;
